# Turn summary
- artifact path: `artifacts\turn_audit\battery_v2_run\t03_nonconvergence_preservation_honesty.json` (field: input artifact file)
...
- active execution mode: `idle` (field: final_outcome.active_execution_mode)
