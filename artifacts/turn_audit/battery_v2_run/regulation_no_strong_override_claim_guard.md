# Turn summary
- artifact path: `artifacts\turn_audit\battery_v2_run\regulation_no_strong_override_claim_guard.json` (field: input artifact file)
...
- decision restrictions: dispatch_contract_must_be_read, topology_bound_to_rt01_contour, production_route_forbids_ablation_flags (field: route_and_scope.decision_restrictions)
...
- epistemic status: `UNRESOLVED_FOR_V1` (field: phase_surfaces.epistemics.epistemic_status)
- epistemic confidence: `UNRESOLVED_FOR_V1` (field: phase_surfaces.epistemics.epistemic_confidence)
- epistemic source_class: `UNRESOLVED_FOR_V1` (field: phase_surfaces.epistemics.epistemic_source_class)
- epistemic modality: `UNRESOLVED_FOR_V1` (field: phase_surfaces.epistemics.epistemic_modality)
- regulation pressure level: `UNRESOLVED_FOR_V1` (field: phase_surfaces.regulation.regulation_pressure_level)
- regulation escalation stage: `UNRESOLVED_FOR_V1` (field: phase_surfaces.regulation.regulation_escalation_stage)
- regulation override scope: `UNRESOLVED_FOR_V1` (field: phase_surfaces.regulation.regulation_override_scope)
- regulation no_strong_override_claim: `UNRESOLVED_FOR_V1` (field: phase_surfaces.regulation.regulation_no_strong_override_claim)
- regulation gate_accepted: `UNRESOLVED_FOR_V1` (field: phase_surfaces.regulation.regulation_gate_accepted)
- regulation source_state_ref: `UNRESOLVED_FOR_V1` (field: phase_surfaces.regulation.regulation_source_state_ref)
...
| --- | --- | --- | --- | --- |
| `rt01.epistemic_admission_checkpoint` | `UNRESOLVED_FOR_V1` | `UNRESOLVED_FOR_V1` | `UNRESOLVED_FOR_V1` | `UNRESOLVED_FOR_V1` |
| `rt01.shared_runtime_domain_checkpoint` | `UNRESOLVED_FOR_V1` | `UNRESOLVED_FOR_V1` | `UNRESOLVED_FOR_V1` | `UNRESOLVED_FOR_V1` |
...
- dispatch restrictions: dispatch_contract_must_be_read, topology_bound_to_rt01_contour, production_route_forbids_ablation_flags (field: restrictions_and_forbidden_shortcuts.dispatch_restrictions)
- downstream gate restrictions: [] (explicit empty list) (field: restrictions_and_forbidden_shortcuts.downstream_gate_restrictions)
- epistemic allowance restrictions: UNRESOLVED_FOR_V1 (field: restrictions_and_forbidden_shortcuts.epistemic_allowance_restrictions)
...
- epistemic_should_abstain: `UNRESOLVED_FOR_V1` (field: uncertainty_and_fallbacks.epistemic_should_abstain)
- epistemic_claim_strength: `UNRESOLVED_FOR_V1` (field: uncertainty_and_fallbacks.epistemic_claim_strength)
- epistemic_allowance_reason: `UNRESOLVED_FOR_V1` (field: uncertainty_and_fallbacks.epistemic_allowance_reason)
- epistemic_unknown_reason: `UNRESOLVED_FOR_V1` (field: uncertainty_and_fallbacks.epistemic_unknown_reason)
- epistemic_conflict_reason: `UNRESOLVED_FOR_V1` (field: uncertainty_and_fallbacks.epistemic_conflict_reason)
- epistemic_abstain_reason: `UNRESOLVED_FOR_V1` (field: uncertainty_and_fallbacks.epistemic_abstain_reason)
- regulation_no_strong_override_claim: `UNRESOLVED_FOR_V1` (field: uncertainty_and_fallbacks.regulation_no_strong_override_claim)
- regulation_gate_accepted: `UNRESOLVED_FOR_V1` (field: uncertainty_and_fallbacks.regulation_gate_accepted)
