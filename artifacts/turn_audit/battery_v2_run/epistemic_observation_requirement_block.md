# Turn summary
- artifact path: `artifacts\turn_audit\battery_v2_run\epistemic_observation_requirement_block.json` (field: input artifact file)
...
- enforced detour checkpoint ids: rt01.world_seam_checkpoint, rt01.world_entry_checkpoint, rt01.outcome_resolution_checkpoint (field: checkpoints.enforced_detour_checkpoint_ids)
