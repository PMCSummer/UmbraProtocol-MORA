...
def o02_intersubjective_allostasis_snapshot(
    ...
    return {
        "state": {
            ...
            "s05_shape_modulation_applied": result.state.s05_shape_modulation_applied,
            "prior_mode_carry_applied": result.state.prior_mode_carry_applied,
            "strong_disagreement_guard_applied": result.state.strong_disagreement_guard_applied,
