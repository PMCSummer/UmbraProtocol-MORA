...
def build_viability_telemetry(
    *,
    ...
    return ViabilityTelemetry(
        ...
        preference_epistemic_block_count=state.preference_epistemic_block_count,
...
def viability_result_snapshot(result: ViabilityControlResult) -> dict[str, object]:
    ...
    return {
        ...
        "telemetry": {
            ...
            "calibration_formula_version": result.telemetry.calibration_formula_version,
            ...
            "preference_epistemic_block_count": result.telemetry.preference_epistemic_block_count,
