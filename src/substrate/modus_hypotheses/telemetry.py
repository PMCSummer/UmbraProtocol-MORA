...
def modus_hypothesis_result_snapshot(result: ModusHypothesisResult) -> dict[str, object]:
    ...
    return {
        ...
        "telemetry": {
            ...
            "l06_downstream_absent": result.telemetry.l06_downstream_absent,
            "discourse_update_consumer_absent": result.telemetry.discourse_update_consumer_absent,
            "repair_trigger_consumer_absent": result.telemetry.repair_trigger_consumer_absent,
