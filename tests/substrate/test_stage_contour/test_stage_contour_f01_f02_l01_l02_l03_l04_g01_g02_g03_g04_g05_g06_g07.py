...
def test_stage_contour_f01_f02_l01_l02_l03_l04_g01_g02_g03_g04_g05_g06_g07_preserves_single_write_seam() -> None:
    ...
    intervention_result = build_targeted_clarification(acquisition_result, framing_result)
    ...
    assert intervention_result.bundle.l06_update_proposal_absent is True
...
def test_stage_contour_g07_typed_only_guard_no_raw_or_single_input_bypass() -> None:
    with pytest.raises(TypeError):
        build_targeted_clarification("raw acquisition", "raw framing")
