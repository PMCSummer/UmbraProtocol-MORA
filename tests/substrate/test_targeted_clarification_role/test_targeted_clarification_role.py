...
def test_uncertainty_structure_changes_intervention_status(g07_factory) -> None:
    ...
    low_conflict = build_targeted_clarification(base.acquisition, base.framing)
    ...
    high_conflict = build_targeted_clarification(base.acquisition, high_conflict_framing)
...
def test_confidence_alone_does_not_drive_ask_policy(g07_factory) -> None:
    ...
    high_conf = build_targeted_clarification(high_conf_acq, base.framing)
    low_conf = build_targeted_clarification(low_conf_acq, base.framing)
