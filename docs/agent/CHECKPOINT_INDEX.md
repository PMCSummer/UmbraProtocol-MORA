...
| `rt01.t03_hypothesis_competition_checkpoint` | `t03_hypothesis_competition.silent_convergence` | `src/substrate/subject_tick/update.py` | `T03` consumed by `RT01` | `require_t03_convergence_consumer`, `require_t03_frontier_consumer`, `require_t03_nonconvergence_preservation` | non-consumable convergence/frontier/nonconvergence preservation enforces detour | `test_subject_tick_t03_convergence_consumer_requirement_is_path_affecting`, `test_subject_tick_t03_nonconvergence_preservation_requirement_is_path_affecting`, `test_dispatch_t03_convergence_consumer_requirement_is_load_bearing`, `test_dispatch_t03_nonconvergence_preservation_requirement_is_load_bearing` | EXPLICIT |
