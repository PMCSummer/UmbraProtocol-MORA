# Checkpoint Index (RT01/S02/S03/T01/T02/T03 contour)
...
## B) Direct S02/S03/T01/T02/T03 integration checkpoints
...
| `rt01.s03_ownership_weighted_learning_checkpoint` | `s03_ownership_weighted_learning.update_routing` | `src/substrate/subject_tick/update.py` | `S03` consumed by `RT01` | `require_s03_learning_packet_consumer`, `require_s03_mixed_update_consumer`, `require_s03_freeze_obedience_consumer` | unmet learning/mixed/freeze readiness enforces detour; positive mixed-ready and learning-ready branches stay allowed without detour | `test_subject_tick_s03_learning_packet_consumer_requirement_is_path_affecting`, `test_subject_tick_s03_mixed_update_consumer_requirement_is_path_affecting`, `test_subject_tick_s03_freeze_obedience_consumer_requirement_is_path_affecting`, `test_subject_tick_s03_positive_consumer_ready_path_has_no_detour`, `test_subject_tick_s03_mixed_update_consumer_positive_path_is_load_bearing_without_detour`, `test_subject_tick_s03_learning_packet_consumer_requirement_is_path_affecting_without_ablation`, `test_subject_tick_s03_freeze_obedience_consumer_requirement_is_path_affecting_without_ablation`, `test_dispatch_s03_learning_packet_consumer_requirement_is_load_bearing`, `test_dispatch_s03_mixed_update_consumer_requirement_is_load_bearing`, `test_dispatch_s03_freeze_obedience_consumer_requirement_is_load_bearing`, `test_dispatch_s03_positive_consumer_ready_path_has_no_detour`, `test_dispatch_s03_mixed_update_consumer_positive_path_is_load_bearing_without_detour` | EXPLICIT |
