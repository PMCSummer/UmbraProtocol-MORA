...
- `docs/seams/S03.seam.md` *(direct adjacent contract input to RT01 contour)*
...
- Mandatory runtime graph checkpoints:
  ...
  - `rt01.s02_prediction_boundary_checkpoint` *(direct adjacent, now tracked in this capsule)*
  - `rt01.s03_ownership_weighted_learning_checkpoint` *(direct adjacent, now tracked in this capsule)*
...
6. Direct-adjacent check when S02 consumer flags/checkpoint exposure changes:
...
7. Direct-adjacent check when S03 consumer flags/checkpoint exposure changes:
